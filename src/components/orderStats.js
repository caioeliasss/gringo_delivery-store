      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} md={3}>
          ...
          >
            ...
            <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 0.5 }}>
              {(stats?.statusCount.em_preparo || 0) + (stats?.statusCount.em_entrega || 0)}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              Em Preparo/Entrega
            </Typography>
        ...
        <Grid container spacing={2}>
          <Grid item xs={4} sm={2}>
            <Box sx={{ textAlign: 'center' }}>
              <Typography color="warning.main" variant="h6" sx={{ fontWeight: 'bold' }}>
          ...
          <Grid item xs={4} sm={2}>
            <Box sx={{ textAlign: 'center' }}>
              <Typography color="primary.main" variant="h6" sx={{ fontWeight: 'bold' }}>
          ...
          <Grid item xs={4} sm={2}>
            <Box sx={{ textAlign: 'center' }}>
              <Typography color="info.main" variant="h6" sx={{ fontWeight: 'bold' }}>
          ...
          <Grid item xs={4} sm={2}>
            <Box sx={{ textAlign: 'center' }}>
              <Typography color="success.main" variant="h6" sx={{ fontWeight: 'bold' }}>
          ...
          <Grid item xs={4} sm={2}>
            <Box sx={{ textAlign: 'center' }}>
              <Typography color="error.main" variant="h6" sx={{ fontWeight: 'bold' }}>
